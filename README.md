...
1. In [Contacts](https://sendgrid.com/marketing_campaigns/contacts), click the **Add List or Segment** button, and select the **New Segment** option. ![](https://media.giphy.com/media/FYEG95biIwIY8/giphy.gif)
